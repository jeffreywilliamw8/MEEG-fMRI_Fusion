...
# 1. Define Area groupings (Using your V1-IT hierarchy)
areas = [
    ['V1'], 
    ['V2'], 
    ['hV4'], 
...
for area_rois in tqdm(areas, desc="Areas"):
    ...
    for subject in subject_list:
        ...
        for roi in area_rois:
            ...
            vis_path = f"/scratch/jeffreykatab/Code/Encoding_Models/THINGS/correlations/joint_meg_feature_encoding/roi/visual/fmri_sub-{subject}/{roi}.npy"
            lang_path = f"/scratch/jeffreykatab/Code/Encoding_Models/THINGS/correlations/joint_meg_feature_encoding/roi/language/fmri_sub-{subject}/{roi}.npy"

            vis_path = f"/scratch/jeffreykatab/Code/Encoding_Models/THINGS/correlations/joint_meg_feature_encoding/roi/language/fmri_sub-{subject}/{roi}.npy"
            lang_path = f'/scratch/jeffreykatab/Code/Encoding_Models/THINGS/correlations/joint_meg_feature_encoding/roi/concepts/fmri_sub-{subject}/{roi}.npy'
...
vars_labels = ['Description Embeddings', 'Concept Embeddings']
...
plt.suptitle('Joint MEG-Feature Encoding: Visual vs. Language', fontsize=16, y=0.99, fontweight='bold')

axes[-1].set_xlabel('Time (ms)')
plt.tight_layout(rect=[0, 0, 1, 0.94])

save_path = os.path.join(PLOTS_DIR, 'JMFE_Visual_vs_Language.png')
